...
- Mobile Lighthouse — 99 performance, 100 accessibility, 100 best practices, 100 SEO; FCP 985 ms, LCP 1,585 ms, TBT 67 ms, CLS 0, and 120,762 bytes. See [JSON](evidence/repair-8/lighthouse.report.json) and [HTML](evidence/repair-8/lighthouse.report.html).
